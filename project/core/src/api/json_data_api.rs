...
pub async fn get_json_data_api(req: Request<Body>) -> Result<Response<Body>, Infallible> {
...
pub async fn post_json_data_api(req: Request<Body>) -> Result<Response<Body>, Infallible> {
